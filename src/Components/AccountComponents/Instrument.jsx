        ...
        < div className="container mx-auto p-2 border-4 border-emerald-700 bg-green-400 m-4 ">
            ...
            <div className="flex-row">
                <div className="flex justify-between">
                    <h3 className="instrumentTenure">Rate : <strong>{props.rate}</strong> | Tenure : <strong>{props.tenure}</strong></h3>
                    <h3 className="instrumentAmount"><strong>₹{props.amount}</strong></h3>
                </div>
            </div>
        </div >
    )
